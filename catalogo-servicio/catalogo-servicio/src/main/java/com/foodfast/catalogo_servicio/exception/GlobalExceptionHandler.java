...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> manejarServicioExterno(ServicioExternoException ex, HttpServletRequest request) {
        log.warn("Servicio externo no disponible: {} ruta={}", ex.getMessage(), request.getRequestURI());
        return construirError(HttpStatus.SERVICE_UNAVAILABLE, ex.getMessage(), request.getRequestURI(), null);
    }
    ...
    private ResponseEntity<ErrorResponse> construirError(HttpStatus estado, String mensaje, String ruta, Map<String, String> validaciones) {
