...
import com.foodfast.reparto_servicio.config.RequestHeaderContext;

@Configuration
public class WebClientConfig {

    @Bean
    public WebClient pedidoWebClient(@Value("${services.pedido.url:http://localhost:8083}") String pedidoServiceUrl) {
        return WebClient.builder()
                ...
                .baseUrl(pedidoServiceUrl).build();
    }
}
